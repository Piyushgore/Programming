...
struct Inode inodeobj[MAXINODE];
...
////////////////////////////////////////////////////////////////////////
//
//  Function Name :     StartAuxilliaryDataInitialisation()
//  Description :       It is used to call all such functions
//                      which are used to initialise auxilliary data
//  Author :            Piyush Ganesh Gore
//  Date :              31/07/2026
//
////////////////////////////////////////////////////////////////////////

void StartAuxilliaryDataInitialisation()
{
...
void DisplayHelp()
{
    ...
    printf("exit : It is used terminate Marvellous CVFS\n");
...
//  Description :       It is used to create file new file
              ...
              )
{
    ...
    // Allocate memory for file's data  (Data Block)
...
//  Description :       It is used to write the data into
//                      specific file
...
//  Description :       It is used to read the data from
//                      specific file
//  Input :             File Decriptor
...
int main()
{
    ...
    StartAuxilliaryDataInitialisation();
    ...
    while(1)
    {
        ...
        else if(iCount == 2)
        {
            ...
            else if(strcmp(Command[0],"write") == 0)
            {
                ...
                {
                    printf("%d bytes gets successfully returned into the file\n",iRet);
                }
            }
